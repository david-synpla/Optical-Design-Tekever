...
Stage: C0 COMPLETE; bounded Stage C1 architecture investigations C01–C04 COMPLETE through Run 020; C04 retains one conditional economic point and cross-portfolio C1 closure/RFQ readiness is next
...
| C04 | Cost/COTS-maximized dual-channel branch | CONDITIONAL ACTIVE through C04-N1400/B09; other tested derivatives PARKED | Catalogue 353/1600 large powered figure plus stock flat and only two small custom spherical SWIR elements; exact first order and ~9.22 um dense SWIR RMS | 273 L / 1.455 m package, 8.28 kg donor primary, guaranteed >=311.371 mm clear figure and qualified SWIR coating not yet supplied |
...
No Track C candidate has been frozen or selected. Run 020 is a bounded economic architecture experiment, not detailed prescription/tolerance optimization, CAD, an RFQ or a production-cost model; catalogue prices and its package/mass/economic classes remain engineering evidence. Run 016's physical C02 doublets remain parked. Run 014 package ranges and ordinal risk classes remain engineering hypotheses, not customer requirements, CAD results or quotations.
