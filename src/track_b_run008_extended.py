...
out=m.ROOT/'runs/run_008'; x=json.loads((out/'configuration.json').read_text())['best']; o=m.build(x)
...
ax.set(xlabel='Axial position from primary vertex (mm)',ylabel='Y (mm)',title='B05 attempt 1 — finite apertures, mirror sag and surviving meridional rays')
