"""Read-only numerical rechecks of Run 007; writes only new audit artifacts."""
...
import track_b_run007_physical as m

out=m.ROOT/'runs/run_007'; x=json.loads((out/'configuration.json').read_text())['best']
...
axes[0,0].legend(fontsize=8); fig.suptitle('B04 physical pupil — diffraction-aware screening at a common detector plane')
